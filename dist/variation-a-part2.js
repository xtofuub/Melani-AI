...
function VAFeatures({
  ...
  }, "A small, sharp set of tools \u2014 ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: theme.brand
    }
...
function BridgeGraphic({
  ...
  }, "radare2"), arrow, /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '6px 10px',
  ...
  }, "MCP"), arrow, /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '6px 10px',
      border: `1px solid ${theme.rule}`,
      borderRadius: 5,
...
function VAWorkflow({
  ...
  }, "Three steps between ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: theme.brand
    }
...
function VASecurity({
  ...
  }, "Binder is designed for analysts working with sensitive samples. Keep work separated by project, manage who can see each case, and choose the model path that fits the job."))), /*#__PURE__*/React.createElement(Reveal, {
    delay: 150,
    y: 30
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, [['Sensitive samples', 'Built for private analysis'], ['Access controls', 'Team-ready permissions'], ['Workspace data', 'Protected by design'], ['Model choices', 'Use cloud or local models'], ['Deployment path', 'Designed to scale with teams'], ['Team access', 'Ready for admin workflows']].map(([k, v]) => /*#__PURE__*/React.createElement("div", {
    key: k,
    style: {
      background: theme.paper,
...
function VAFaq({
  ...
  const faqs = [{
    ...
    a: 'Binder can route different tasks to different model options, so teams can balance speed, depth, and privacy needs as their workflow matures.'
  }, {
    ...
    a: 'Per-seat for individuals and small teams, with volume discounts for researchers. Team plans can add admin workflows, higher sample volume, and guided onboarding. Academic and CTF licenses are free.'
  }];

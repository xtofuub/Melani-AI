...
function getEditorialChatStyles(theme) {
  ...
  const blue = t.brand || t.terminalAccent || t.accent;
  return {
    wrap: {
      background: t.paper,
      border: isDark ? `1px solid rgba(0,98,209,0.26)` : `1px solid ${t.rule}`,
      borderRadius: 14,
      overflow: 'hidden',
      boxShadow: isDark ? '0 30px 80px -30px rgba(0,0,0,0.85), 0 10px 28px -16px rgba(0,0,0,0.6), 0 0 0 1px rgba(0,98,209,0.08) inset' : t.elevatedShadow,
    ...
    headerDot: {
      ...
      height: 8,
      borderRadius: 8,
      background: isDark ? blue : t.accent,
      boxShadow: isDark ? '0 0 0 4px rgba(0,98,209,0.16)' : `0 0 0 4px ${t.accentRing}`
    },
    headerTitle: {
      fontSize: 13,
      color: t.inkSoft,
    ...
    codeBlock: {
      ...
      padding: '10px 14px',
      background: t.panel,
      border: isDark ? '1px solid rgba(0,98,209,0.28)' : `1px solid ${t.rule}`,
      borderRadius: 8,
      fontFamily: 'JetBrains Mono, monospace',
      fontSize: 13,
      color: t.inkSoft
    ...
    cite: {
      ...
      padding: '3px 8px',
      borderRadius: 20,
      background: isDark ? 'rgba(0,98,209,0.09)' : t.cream,
      color: isDark ? 'rgba(148,190,255,0.82)' : t.muted,
      border: isDark ? '1px solid rgba(0,98,209,0.22)' : `1px solid ${t.rule}`
    },
    typing: {
      alignSelf: 'flex-start',
      color: t.accent,
...
const editorialChatStyles = {
  ...
  headerDot: {
    ...
    borderRadius: 8,
    background: '#0062D1',
    boxShadow: '0 0 0 4px rgba(0,98,209,0.14)'
  },
  headerTitle: {
    fontSize: 13,
    color: '#1a1a1a',

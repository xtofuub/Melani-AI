  ...
  const steps = [
    {
      n: '01',
      title: 'Upload',
      body: 'Drop a PE, ELF, Mach-O, or raw firmware image. Melani detonates in a sandbox, unpacks if needed, and indexes strings, imports, and control flow.',
      code: 'stager_x64.elf · 412 KB · ELF · 64-bit',
    },
    {
      n: '02',
      title: 'Converse',
      body: "Ask in plain English. Melani answers with evidence — addresses, byte patterns, decoded strings — and keeps context across a whole session.",
      code: '> what\'s the C2?',
    },
    {
      n: '03',
      ...
      <div style={{ maxWidth: 1120, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: 16.5, color: theme.inkSoft, lineHeight: 1.65, textWrap: 'pretty' }}>
            ...
            and never used to train models. Deploy Melani in our cloud, in your VPC, or fully
...
function VAFaq({ theme, serif, mono }) {
  const faqs = [
    {
      q: 'What can I upload?',
      a: 'Melani is built for PE, ELF, Mach-O, APKs, firmware images, memory dumps, shellcode, and packed samples. It extracts strings, imports, sections, symbols, control flow, and suspicious behaviors before the chat layer starts answering.',
    },
    {
      q: 'How does Melani avoid vague AI answers?',
      a: 'Answers are grounded in evidence from the sample: addresses, byte ranges, decoded strings, imports, function names, and execution notes. When Melani makes a claim, it shows the trail so you can jump back to the artifact and verify it yourself.',
    },
    {
      q: 'Can I choose where analysis runs?',
      a: 'Yes. Teams can use hosted models for speed, route sensitive work to private deployments, or connect local models for restricted environments. The goal is to keep model choice separate from the analyst workflow.',
    },
    {
      q: 'Does it replace IDA, Ghidra, or Binary Ninja?',
      a: 'No. Melani sits beside your reversing tools. Use it to summarize, rename, explain, search, and prepare notes, then push useful findings back into IDA, Ghidra, Binary Ninja, or radare2.',
    },
    {
      q: 'What happens to uploaded samples?',
      a: 'Samples are isolated by workspace and treated as private analysis material. For team deployments, access controls, retention rules, and model routing can be configured around your internal security requirements.',
    },
    {
      q: 'How do teams get started?',
      a: 'Start with one analyst workflow: upload a real sample, ask Melani to map behavior, review the cited evidence, then export notes back to your case file. From there, teams can add shared workspaces, higher volume, and private deployment options.',
    },
  ];
        ...
        <div style={{ position: 'relative', zIndex: 2, display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 80, alignItems: 'end' }}>
          ...
          <div>
            <p style={{ fontSize: 16, color: 'rgba(250,250,249,0.7)', lineHeight: 1.6, marginBottom: 28, textWrap: 'pretty' }}>
              See Melani against a real sample of yours. We'll walk through the analysis live and
